...
export const getNearbyRides = catchAsync(
...
export const getSingleRideForRider = catchAsync(
  async (req: Request, res: Response) => {
...
export const getDriverRides = catchAsync(
  async (req: Request, res: Response) => {
...
export const getDriverEarnings = catchAsync(
  async (req: Request, res: Response) => {
    const driverId = (req.user as any).userId;
