...
export const updateUserZodSchema = z.object({
  ...
  vehicleInfo: z
    .object({
      model: stringWithCustomTypeError("Vehicle model must be string").max(
        100,
        { message: "Vehicle model cannot exceed 100 characters." }
      ),
      plateNumber: stringWithCustomTypeError(
        "Vehicle plate number must be string"
      ).max(20, {
