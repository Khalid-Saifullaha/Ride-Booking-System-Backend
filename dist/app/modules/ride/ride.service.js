...
const getMyRides = (riderId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield ride_model_1.Ride.find({ rider: new mongoose_1.Types.ObjectId(riderId) })
        .populate("driver")
        .populate("rider")
        .sort({ createdAt: -1 });
});
const getDriverRides = (driverId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield ride_model_1.Ride.find({ driver: new mongoose_1.Types.ObjectId(driverId) })
        .populate("rider")
        .sort({ createdAt: -1 });
});
